...
Usage:
    from draagon_ai.services.roxy_feedback import RoxyFeedbackCollector

    collector = RoxyFeedbackCollector()
...
class RoxyFeedbackCollector:
    ...
    Example:
        collector = RoxyFeedbackCollector(storage_path=Path("./feedback"))
