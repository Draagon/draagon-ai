...
This module schedules and runs evolution cycles for AI assistant behavior.
It monitors interaction feedback and triggers evolution when conditions are met.

Usage:
    from draagon_ai.services import EvolutionScheduler
...
from .evolution import EvolutionService, EvolutionServiceResult
from .feedback import FeedbackCollector, FeedbackStats
...
class EvolutionRun:
    ...
    result: EvolutionServiceResult | None = None
    applied: bool = False
...
class EvolutionScheduler:
    ...
    def __init__(
        ...
        on_evolution_complete: Callable[[EvolutionServiceResult], Awaitable[None]] | None = None,
    ):
    ...
    async def maybe_evolve(self) -> EvolutionServiceResult | None:
    ...
    async def evolve(self) -> EvolutionServiceResult:
        """Run evolution cycle.
