"""Roxy Evolution Service.

This module provides a unified evolution service for Roxy that combines:
...
The service enables Roxy's behavior to improve over time based on:
- User interaction feedback
- Success/failure patterns
- User corrections

Usage:
    from draagon_ai.services.roxy_evolution import RoxyEvolutionService

    service = RoxyEvolutionService(llm=llm_adapter, behavior=roxy_behavior)
...
@dataclass
class RoxyEvolutionConfig:
    """Configuration for Roxy evolution."""
...
@dataclass
class RoxyEvolutionResult:
    """Result from Roxy evolution."""
...
class VoiceAssistantFitnessEvaluator:
    ...
    def __init__(
        self,
        llm: LLMProvider,
        config: RoxyEvolutionConfig | None = None,
    ):
        ...
        """
        self._llm = llm
        self.config = config or RoxyEvolutionConfig()
...
class RoxyEvolutionService:
    """Unified evolution service for Roxy.

    This service combines Promptbreeder and Context Evolution
    to provide a complete evolution pipeline for Roxy's behavior.

    Example:
        service = RoxyEvolutionService(llm=llm_adapter, behavior=behavior)
    ...
    def __init__(
        ...
        self._evolution_history: list[RoxyEvolutionResult] = []
    ...
    async def evolve_decision_prompt(
        ...
        # Create result
        evo_result = RoxyEvolutionResult(
            success=True,
            prompt_result=result,
            original_fitness=original_fitness,
            evolved_fitness=evolved_fitness,
    ...
    def get_evolution_history(self) -> list[RoxyEvolutionResult]:
