...
Example:
    >>> from draagon_ai.cognition.decomposition import EvolvingSynsetDatabase
    >>> from draagon_ai.cognition.decomposition.identifiers import LearnedSynset, SynsetSource
    >>>
